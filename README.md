## SE-FFTNet: A non-causal FFTNet architecture for speech enhancement
...
Go to the ```./src``` folder, and compile the ```generate.sh``` file with first argument as the the id of the saved model, like 1 or 2 ..
